...
const VERSION='20260815-college-acceptance-v15-final-lightfield';
const W=1080,H=1350;
...
const inner=document.createElement('canvas');inner.width=gw;inner.height=gh;const nx=inner.getContext('2d'),innerW=Math.min(gw-80,Math.ceil(aw+180)),innerH=Math.max(64,Math.ceil(ah*.96)),ix=(gw-innerW)/2,iy=cy-innerH/2;let iv=nx.createLinearGradient(0,iy,0,iy+innerH);iv.addColorStop(0,'rgba(255,255,255,0)');iv.addColorStop(.16,'rgba(255,255,255,.34)');iv.addColorStop(.32,'rgba(255,255,255,.72)');iv.addColorStop(.50,'rgba(255,255,255,.90)');iv.addColorStop(.68,'rgba(255,255,255,.72)');iv.addColorStop(.84,'rgba(255,255,255,.34)');iv.addColorStop(1,'rgba(255,255,255,0)');nx.fillStyle=iv;nx.fillRect(ix,iy,innerW,innerH);nx.globalCompositeOperation='destination-in';let ihg=nx.createLinearGradient(ix,0,ix+innerW,0);ihg.addColorStop(0,'rgba(0,0,0,0)');ihg.addColorStop(.06,'rgba(0,0,0,.28)');ihg.addColorStop(.14,'rgba(0,0,0,.72)');ihg.addColorStop(.22,'rgba(0,0,0,1)');ihg.addColorStop(.78,'rgba(0,0,0,1)');ihg.addColorStop(.86,'rgba(0,0,0,.72)');ihg.addColorStop(.94,'rgba(0,0,0,.28)');ihg.addColorStop(1,'rgba(0,0,0,0)');nx.fillStyle=ihg;nx.fillRect(ix,iy,innerW,innerH);nx.globalCompositeOperation='source-over';gx.save();gx.filter='blur(14px)';gx.drawImage(inner,0,0);gx.restore();
