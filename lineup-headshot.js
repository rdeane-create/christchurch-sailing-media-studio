(function(){
  ...
  const VERSION='20260814-lineup-headshot-v5-background-controls';
  const W=1080,H=1350;
  ...
  const S={img:null,scale:1,x:0,y:0,drag:false,sx:0,sy:0,ix:0,iy:0,bg:null,bgScale:1,bgX:0,bgY:0,bgOpacity:1,first:'WYLDER',last:'SMITH',classLine:'CLASS OF 2027',cardNameDirty:false,overlay:null,atlas:null,ready:false};
