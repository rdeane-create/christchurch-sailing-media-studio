(function(){
  ...
  async function saveFinishedCard(){
    ...
    try{
      ...
      if(typeof window.CSMSRenderSavedHeadshotCards==='function'){
        if(window.__CSMS_SAVED_HEADSHOT_CARDS_LOADED)await window.CSMSRenderSavedHeadshotCards();
      }else{
