...
(function () {
  ...
  const fresh = () => ({title:'The Seahorse Sailing Newsletter', issue:'Issue 01', date:new Date().toLocaleDateString('en-US',{month:'long',day:'numeric',year:'numeric'}), intro:'News from the water, the classroom, and our sailing community.', hero:'', heroAlt:'Christchurch Sailing', facebook:'', instagram:'', sections:titles.map(title=>({title,visible:true,body:'',image:'',alt:'',link:'',linkLabel:'Read more'}))});
