(function(){
  'use strict';
  const VERSION='20260831-regatta-lineup-video-route-team-intro-sequential-v3';
  ...
  function loadTeamIntroductionHelper(){
    ...
    script.src='team-introduction-layout-v1.js?v=20260831-sequential-hero-footer-v3';
    script.async=false;
